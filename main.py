...
class ServerFetchMod(loader.Module):
    ...
    strings = {
        "name": "ServerFetch",
        "loading_fetch": '<emoji document_id=5192765204898783881></emoji> <b>Rendering fetch...</b>',
        "loading_ol": '<emoji document_id=5192765204898783881></emoji> <b>Collecting system stats...</b>',
        "fetch_missing": (
            '<emoji document_id=5192765204898783881></emoji> <b>Neither <code>neofetch</code> nor <code>fastfetch</code> was found.</b>\n'
            "<i>Ubuntu:</i> <code>sudo apt update && sudo apt install neofetch -y</code>"
        ),
        "fetch_failed": '<emoji document_id=5192765204898783881></emoji> <b>Failed to build fetch screenshot.</b>',
        "ol": (
            '<emoji document_id=5192765204898783881></emoji> <b>Overall load</b>\n\n'
            '<emoji document_id=5192765204898783881></emoji> <b>CPU:</b> {cpu_percent}% (<code>{cores}C/{threads}T</code>)\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Load avg:</b> {loadavg}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>RAM:</b> {ram_used} / {ram_total} ({ram_percent}%)\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Disk /:</b> {disk_used} / {disk_total} ({disk_percent}%)\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Uptime:</b> {uptime}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>OS:</b> {os_name}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Kernel:</b> {kernel}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Python:</b> {python}'
        ),
    }

    strings_ru = {
        "loading_fetch": '<emoji document_id=5192765204898783881></emoji> <b>Рисую fetch...</b>',
        "loading_ol": '<emoji document_id=5192765204898783881></emoji> <b>Собираю статистику...</b>',
        "fetch_missing": (
            '<emoji document_id=5192765204898783881></emoji> <b>Не найден ни <code>neofetch</code>, ни <code>fastfetch</code>.</b>\n'
            "<i>Для Ubuntu:</i> <code>sudo apt update && sudo apt install neofetch -y</code>"
        ),
        "fetch_failed": '<emoji document_id=5192765204898783881></emoji> <b>Не удалось собрать скрин fetch.</b>',
        "ol": (
            '<emoji document_id=5192765204898783881></emoji> <b>Нагрузка сервера</b>\n\n'
            '<emoji document_id=5192765204898783881></emoji> <b>CPU:</b> {cpu_percent}% (<code>{cores}C/{threads}T</code>)\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Load avg:</b> {loadavg}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>RAM:</b> {ram_used} / {ram_total} ({ram_percent}%)\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Диск /:</b> {disk_used} / {disk_total} ({disk_percent}%)\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Аптайм:</b> {uptime}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>OS:</b> {os_name}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Ядро:</b> {kernel}\n'
            '<emoji document_id=5192765204898783881></emoji> <b>Python:</b> {python}'
        ),
